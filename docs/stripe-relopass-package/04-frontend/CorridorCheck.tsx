// SNAPSHOT (2026-07-18) of apps/case-command/CorridorCheck.tsx — the live workspace file is authoritative.
// Import paths reflect the file's real location under apps/case-command/.
