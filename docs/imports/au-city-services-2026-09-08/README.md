# au-city-services-2026-09-08 — Australia city services (draft)
...
- **72 `country_resources` rows** (cities: adelaide, brisbane, canberra, darwin, gold-coast, hobart, melbourne, newcastle, perth, sunshine-coast, sydney, wollongong; 6 services each) — all
  `status='draft'`, `is_visible_to_end_users=false`. 14 `resource_sources`.
- Append-only verified: Australia published/visible unchanged (0→0); totals grew by the inserts.
