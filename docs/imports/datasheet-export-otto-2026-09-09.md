...
| `corridor-content/CN.ndjson` | 18 records | same, mainland China (Foreigner's Work Permit Notification via MOHRSS + Z work visa, 24-hour temporary residence registration at the local Public Security Bureau, Foreigner's Work Permit within 15 days, work-type Residence Permit at the Exit-Entry Administration within 30 days, mandatory health/medical exam, social-insurance participation subject to totalization, Individual Income Tax with the 183-day + six-year rules). Wave 5. Otto split the block across a fence; the truncated boundary duplicate was auto-reconciled against its complete copy and dropped — 18 valid records match Otto's "18 records" count. 0 missing sources. |
| `corridor-content/IN.ndjson` | 19 records | same, India (employer-sponsored Employment Visa, FRRO registration within 14 days via the e-FRRO portal, PAN from the Income Tax Department, income tax with the 182-day residence rule + RNOR + TDS + annual ITR, EPF International Worker provisions with Social Security Agreement Certificate-of-Coverage exemptions, Aadhaar, de-registration on exit). Wave 5. Otto stalled once (nudged) then drifted mid-generation into an off-topic "domain / check_domain_availability" tool-confusion that truncated the ARRIVAL_WEEK FRRO record repeatedly; the 18 other records were clean, and the FRRO record was re-sourced cleanly from a fresh conversation (with an explicit "do not check any domain" instruction) and merged — the truncated copies were auto-reconciled and dropped. 0 missing sources; nothing fabricated. |
| `corridor-content/MX.ndjson` | 19 records | same, Mexico (employer job-offer authorization via INM + Temporary Resident Visa at a consulate, canje/exchange of the visa for the Tarjeta de Residente Temporal at INM within 30 days, CURP, permission to work, RFC at SAT, IMSS social security + INFONAVIT, income tax ISR via SAT with 183-day/centre-of-vital-interests residence + PE). Wave 5 — ReloPass's first Latin American corridor. Clean single block, 0 missing sources. |
| `corridor-content/NZ.ndjson` | 19 records | same, New Zealand (Accredited Employer Work Visa (AEWV) via Immigration NZ with employer accreditation + job check + migrant visa, IRD number from Inland Revenue, PAYE tax with 183-day residence + the 4-year transitional-resident foreign-income exemption, KiwiSaver opt-in for migrants, ACC levies, GP/PHO enrolment + publicly-funded health eligibility for 2-year+ work visas). Wave 6. Clean single block, 0 missing sources. |
| `corridor-content/BR.ndjson` | 18 records | same, Brazil (prior residence/labour authorization from the Ministry of Justice (MJSP) requested by the employer + VITEM V work visa at a consulate, registration with the Polícia Federal within 90 days for the RNM/CRNM residence card, CPF at the Receita Federal, CTPS digital work card, INSS social security, FGTS employer deposits, IRPF income tax + tax residence). Wave 6 — ReloPass's 2nd Latin American corridor. Otto split the block across a fence; the truncated boundary duplicate was auto-reconciled and dropped — 18 valid records match Otto's count. 0 missing sources. |
| `corridor-content/CZ.ndjson` | 19 records | same, Czechia (Employee Card (zaměstnanecká karta) combined work+residence permit via the Ministry of the Interior + prior labour-market vacancy registration, foreign-police registration within 3 working days at the Cizinecká policie, rodné číslo, biometric residence card, public health insurance (VZP), income tax at the Finanční správa + social (ČSSZ) + health contributions, 183-day residence + PE). Wave 6. Fence split-dupe auto-reconciled. 0 missing sources. |
| `corridor-content/FI.ndjson` | 18 records | same, Finland (EU/EEA free movement registered at Migri vs residence permit for an employed person (oleskelulupa TTOL) via Migri; A1 / EHIC and posted-worker AVI notification pre-arrival; DVV domicile registration + personal identity code (henkilötunnus); Vero tax card + tax number; Kela social-security enrolment + public health care; 183-day tax residence, employer PE risk, annual tax return, residence-permit renewal / EU permanent right of residence). Wave 7. Clean single block, 0 missing sources. |
| `corridor-content/TH.ndjson` | 18 records | same, Thailand (Non-Immigrant B visa pre-arrival + work permit via the Ministry of Labour Department of Employment (employer WP.3 petition → employee WP.10), work-permit medical certificate (five prohibited diseases) + police clearance, employer PE-risk pre-assessment; TM.30 residence notification by the landlord, TM.7 annual extension of stay + TM.8 re-entry permit; Thai taxpayer ID + PIT (PND.90/PND.91) with the Revenue Department + PND.1 monthly withholding, Social Security Fund employer registration + monthly contributions, 90-day reporting to the Immigration Bureau, 180-day tax residence + PE). Wave 7. Rendered as inline text (literal `<pre>` markers), single block; 18 valid records match Otto's count; 0 missing sources (immigration.go.th, doe.go.th, rd.go.th, sso.go.th). |
| `corridor-content/ZA.ndjson` | 18 records | same, South Africa (General Work Visa (s19) vs Critical Skills Work Visa (s19A) via the Department of Home Affairs applied at an SA mission, SAQA foreign-qualification evaluation, DHA form BI-811 medical + radiological (chest-X-ray) reports, police clearance, Department of Employment & Labour labour-market certificate; port-of-entry endorsement, professional-body registration (ECSA/HPCSA/etc.) within 6 months; SARS income-tax registration + PAYE DTA directive, UIF employer registration + monthly EMP201, physical-presence tax residence (91/915-day) + employer PE, annual ITR12). Wave 7. Otto drifted into check_domain_availability mid-stream and truncated the `za_radiological_report` record; the other 17 were clean, and that one record was re-sourced from a fresh conversation (explicit "do NOT check any domain; source_url is only a citation") and auto-reconciled against the truncated copy — 18 valid records. 0 missing sources (dha.gov.za, sars.gov.za, saqa.org.za, labour.gov.za); nothing fabricated. |
