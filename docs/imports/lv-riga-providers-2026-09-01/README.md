# Riga, Latvia provider harvest — 2026-09-02 (wave 11, XX-LV)

Register-sourced relocation providers in **Riga, Latvia**, landed to **pending** in the admin vetting
queue; nothing served. Append-only: approved capabilities held at 130.

## Landed (20 rows → pending capabilities)
banks 11 · schools 9

## Registers
- **banks** → Latvijas Banka (national statutory bank register; list page, no per-entity URL — vetter confirms).
