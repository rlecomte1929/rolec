# Vilnius, Lithuania provider harvest — 2026-09-02 (wave 11, XX-LT)

Register-sourced relocation providers in **Vilnius, Lithuania**, landed to **pending** in the admin vetting
queue; nothing served. Append-only: approved capabilities held at 130.

## Landed (11 rows → pending capabilities)
banks 7 · schools 4

## Registers
- **banks** → Lietuvos bankas (national statutory bank register; list page, no per-entity URL — vetter confirms).
