# Lima, Peru provider harvest — 2026-09-02 (wave 10, XX-PE)

Register-sourced relocation providers in **Lima, Peru**, landed to **pending** in the admin vetting
queue; nothing served. Append-only: approved capabilities held at 130.

## Landed (18 rows → pending capabilities)
banks 7 · movers 3 · schools 8

## Registers
- **banks** → SBS (Superintendencia de Banca, Seguros y AFP) (statutory bank register; list page, no per-entity URL — vetter confirms).
