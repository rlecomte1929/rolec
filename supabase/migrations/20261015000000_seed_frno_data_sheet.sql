...
VALUES (
  ...
  '[
    ...
    {"id":"arrival_date","section":"eea_registration","label":"Date of arrival in Norway","label_nb":"Ankomstdato i Norge","type":"date","required":true,"requires_original":false,"position":10,"note":"Not derivable from the intake profile or contract — the employee supplies it. Starts the three-month registration clock."},
    ...
    {"id":"intended_stay_months","section":"folkeregister","label":"Intended length of stay (months)","label_nb":"Planlagt oppholdslengde (maneder)","type":"number","required":true,"requires_original":false,"position":15,"portal_url":"https://www.skatteetaten.no/en/person/national-registry/identitetsnummer-og-elektronisk-id/fodselsnummer/","note":"The split keys off ACTUAL intended stay, not the assignment label: report a move to Norway and obtain a national identity number if staying at least six months consecutively or more permanently; below that the D-number applies. The fodselsnummer supersedes any D-number. Not derivable from the profile or contract — the employee supplies it."},
