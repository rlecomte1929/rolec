...
**System of record:** Each finding has a Notion AI Work Queue entry (DB id `3bc887c6-4d48-8089-8188-fcf2dc3edc1b`) with Priority + Complexity + Validation Criteria + Context Links back to the originating `audit/02-expert-*.md` file. Update Status as the work moves through `Ready for AI → AI in Progress → Human Review → Done`.
