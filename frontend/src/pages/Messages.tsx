    ...
    <div className="border-b border-[#e2e8f0] p-3 space-y-2 bg-[#fafbfc] shrink-0">
      <div className="flex flex-col gap-2 sm:flex-row sm:flex-wrap sm:items-center sm:gap-2">
        <Input unstyled
          ...
          className="flex-1 min-w-[160px] rounded-lg border border-[#e2e8f0] px-3 py-2 text-sm text-[#1A1A1A] placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-[#1d4ed8]/30"
