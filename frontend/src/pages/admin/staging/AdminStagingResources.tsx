    ...
    >
      <div className="space-y-4">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <div className="w-40">
            <CountryPicker value={filters.country_code} onChange={(v) => setFilters((f) => ({ ...f, country_code: v }))} valueMode="code" placeholder="Country code" testId="staging-res-country" />
          </div>
          <div className="w-40">
            <CityPicker value={filters.city_name} onChange={(v) => setFilters((f) => ({ ...f, city_name: v }))} placeholder="City" testId="staging-res-city" />
          </div>
          <Link
