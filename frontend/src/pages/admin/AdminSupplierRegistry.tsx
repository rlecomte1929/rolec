...
export const AdminSupplierRegistry: React.FC = () => {
  ...
  return (
    <AdminLayout
      ...
      subtitle="Browse and edit suppliers by service category"
      headerRight={
        <Link to={ROUTE_DEFS.adminSuppliers.path} className="text-sm font-medium text-accent-600 hover:text-accent-700">
          Coverage master
        </Link>
      }
    >
