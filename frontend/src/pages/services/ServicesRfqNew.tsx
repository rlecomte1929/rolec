...
export const ServicesRfqNew: React.FC = () => {
  ...
  return (
    <AppShell title="Request quotations (RFQ)" subtitle={RFQ_SUBTITLE}>
      ...
      {/* [AIQ-1521 follow-up] A mover cannot price a job from "someone is moving". The route, the
          date and the household reach them from your case automatically — these are the things we
          can't know. Anything left blank is shown to them as "Not specified", never guessed. */}
