...
const HrDutyOfCareBoard = lazy(() => import('./pages/HrDutyOfCareBoard').then((module) => ({ default: module.HrDutyOfCareBoard })));
  ...
  return (
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route path={ROUTE_DEFS.hrDutyOfCare.path} element={<RequireHrRoute><HrDutyOfCareBoard /></RequireHrRoute>} />
