...
const GovernancePage = lazy(() => import('./pages/admin/governance/GovernancePage').then((module) => ({ default: module.GovernancePage })));
const AuditLogPage = lazy(() => import('./pages/admin/governance/AuditLogPage').then((module) => ({ default: module.AuditLogPage })));
  ...
  return (
    ...
    <Router>
      ...
      <Routes>
        ...
        <Route path={ROUTE_DEFS.adminGovernance.path} element={<RequireAdminRoute><GovernancePage /></RequireAdminRoute>} />
        <Route path={ROUTE_DEFS.adminAuditLog.path} element={<RequireAdminRoute><AuditLogPage /></RequireAdminRoute>} />
