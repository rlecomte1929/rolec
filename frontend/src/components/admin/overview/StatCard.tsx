...
export const StatCard: React.FC<StatCardProps> = ({ testId, label, value, sub, loading, fallback }) => (
  <div data-testid={testId} className="bg-white rounded-xl border border-slate-200 px-5 py-4 shadow-sm">
