...
SERVICE_STEPS: Dict[str, List[ServiceStep]] = {
    ...
    "spouse": [
        ...
        ServiceStep("cv_review", "CV / credentials review",
                    ...
                    "arrival", 20),
        ServiceStep("job_search_intro", "Job-search partner introduction",
                    "Connect your partner with a job-search partner in the host market.",
                    "arrival", 30),
        ServiceStep("book_coaching", "Book a coaching session",
                    "Book a dual-career coaching session for your partner.",
                    "arrival", 40),
        ServiceStep("labour_market_briefing", "Local labour-market briefing",
                    "Review host-market hiring norms, recognition of credentials, and next steps.",
                    "arrival", 50),
    ],
    "temp": [
