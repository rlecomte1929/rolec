...
def create_case_quote_request(
    ...
    POST /api/rfqs. This router is legacy (not the one serving prod), retained as a 410
    tombstone so no path writes `quote_requests`. The table's historical rows stay readable.
    """
    raise HTTPException(
        status_code=410,
