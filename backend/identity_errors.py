...
class IdentityErrorCode(str, Enum):
    ...
    CLAIM_ASSIGNMENT_NOT_PENDING = "CLAIM_ASSIGNMENT_NOT_PENDING"
    CLAIM_PENDING_CONTACT_MISMATCH = "CLAIM_PENDING_CONTACT_MISMATCH"
    CLAIM_PENDING_COMPANY_MISMATCH = "CLAIM_PENDING_COMPANY_MISMATCH"
    CLAIM_EXTRA_VERIFICATION_REQUIRED = "CLAIM_EXTRA_VERIFICATION_REQUIRED"
