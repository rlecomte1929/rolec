...
from .app.routers import hr_vendor_assignments as hr_vendor_assignments_router  # B16 — /api/hr vendor-curation aliases (dual-layer per CLAUDE.md)
...
app.include_router(hr_vendor_assignments_router.router)  # B16 — /api/hr/{vendor-assignments/pending,employees/waiting}; registered before @app.get /api/hr/employees/{employee_id} (~L3845)
