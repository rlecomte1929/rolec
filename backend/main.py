...
from .app.routers import roadmap_regenerate as roadmap_regenerate_router  # [W1-2] regenerate a case's roadmap — dual-layer per CLAUDE.md
...
app.include_router(roadmap_regenerate_router.router)  # [W1-2] dual-layer per CLAUDE.md: prod boots THIS app
