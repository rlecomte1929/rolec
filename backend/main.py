...
from .app.routers import test_drive_qa as test_drive_qa_router  # QA staged provisioning harness — dual-layer registration per CLAUDE.md
...
app.include_router(test_drive_qa_router.router)  # QA staged provisioning (/api/test-drive/qa/provision-stage) — dual-layer registration
