...
def create_rfq(
    ...
    # to type — while we already knew the route and the date and sent neither. A vendor who
    # can't see the route can't quote, and if they don't reply we'd wrongly conclude "suppliers
    # don't respond" when in fact we asked badly.
    #
