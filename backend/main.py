...
from .app.routers import admin_governance as admin_governance_router  # Governance — allowlist + audit viewer (dual-layer registration)
...
app.include_router(admin_governance_router.router)  # Governance — /api/admin/allowlist + /audit-logs — dual-layer registration
