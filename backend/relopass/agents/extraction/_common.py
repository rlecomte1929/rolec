...
Same module as on the C1-05c branch. Duplicated here because the C1-05c
PR hasn't merged yet; this branch is built off main + cherry-picked
runtime dependencies. GitHub will dedupe across the per-agent PRs.
"""
